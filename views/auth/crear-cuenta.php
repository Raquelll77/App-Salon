...
<form action="/crear-cuenta" method="POST">
    ...
    <div class=" campo">
        ...
        <input type="tel" id="telefono" name="telefono" placeholder="Tu teléfono" value="<?= s($usuario->telefono) ?>">
    </div>
    <div class=" campo">
        <label for="email">Email:</label>
        <input type="email" id="email" name="email" placeholder="Tu e-mail" value="<?= s($usuario->email) ?>">
    </div>
    <div class=" campo">
